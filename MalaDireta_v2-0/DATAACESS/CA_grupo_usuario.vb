Public Class CA_grupo_usuario
  ...
  Public Function Select_Disponiveis(ByRef objDT As DataTable) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "CA_sp_grupo_usuario_SELECT_disponiveis"
  ...
  Public Function Grid(ByRef objDT As DataTable, ByVal strFiltro As String) As Boolean
    ...
    Try
      ...
      If Trim(strFiltro) <> "" Then
        strSql = "CA_sp_grupo_usuario_SELECT_busca '" & strFiltro & "'"
      Else
        strSql = "CA_sp_grupo_usuario_SELECT_grid"
      End If
  ...
  Public Function Select_ONE(ByRef objDT As DataTable, ByVal strParametro As String) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "CA_sp_grupo_usuario_select_one"
  ...
  Public Function Delete(ByVal strParametro As String) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "CA_sp_grupo_usuario_delete_one"
      _FunctionsDB.MontaSQL(strSql, strParametro, Imperia.Common.Functions_DB.tipo_Campo.Numero, False)
  ...
  Public Function Update(ByVal strParametro As String, ByVal REDE_ID_REDE As Integer, ByVal GRUS_TX_DESCRICAO As String, ByVal GRUS_IN_ADMINISTRADOR As String) As Boolean

    Try

      Dim strSql As String = "CA_sp_grupo_usuario_update "
      ...
      _FunctionsDB.MontaSQL(strSql, GRUS_TX_DESCRICAO, Imperia.Common.Functions_DB.tipo_Campo.Texto, True)
      _FunctionsDB.MontaSQL(strSql, GRUS_IN_ADMINISTRADOR, Imperia.Common.Functions_DB.tipo_Campo.Boleano, False)
  ...
  Public Function Insert(ByVal REDE_ID_REDE As Integer, ByVal GRUS_TX_DESCRICAO As String, ByVal GRUS_IN_ADMINISTRADOR As String) As Integer

    Try

      Dim strSql As String = "CA_sp_grupo_usuario_insert "
      _FunctionsDB.MontaSQL(strSql, REDE_ID_REDE, Imperia.Common.Functions_DB.tipo_Campo.Numero, True)
      _FunctionsDB.MontaSQL(strSql, GRUS_TX_DESCRICAO, Imperia.Common.Functions_DB.tipo_Campo.Texto, True)
      _FunctionsDB.MontaSQL(strSql, GRUS_IN_ADMINISTRADOR, Imperia.Common.Functions_DB.tipo_Campo.Boleano, False)
