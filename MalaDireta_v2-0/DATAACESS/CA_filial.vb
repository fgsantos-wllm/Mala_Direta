Public Class CA_filial
  ...
  Public Function Select_Disponiveis(ByRef objDT As DataTable) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "ca_sp_filial_SELECT_disponiveis"
  ...
  Public Function Grid(ByRef objDT As DataTable, ByVal strFiltro As String) As Boolean
    ...
    Try
      ...
      If Trim(strFiltro) <> "" Then
        strSql = "ca_sp_filial_SELECT_busca '" & strFiltro & "'"
      Else
        strSql = "ca_sp_filial_SELECT_grid"
      End If
  ...
  Public Function Select_One(ByRef objDT As DataTable, ByVal strParametro As String) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "ca_sp_filial_SELECT_one"
  ...
  Public Function Delete(ByVal strParametro As String) As Boolean
    ...
    Try
      ...
      Dim strSql As String = "ca_sp_filial_DELETE_one "
      _FunctionsDB.MontaSQL(strSql, strParametro, Imperia.Common.Functions_DB.tipo_Campo.Numero, False)
  ...
  Public Function Update(ByVal strParametro As String, ByVal fili_descricao As String, ByVal fili_in_bloqueado As String) As Boolean

    Try

      Dim strSql As String = "ca_sp_filial_UPDATE "
      _FunctionsDB.MontaSQL(strSql, strParametro, Imperia.Common.Functions_DB.tipo_Campo.Numero, True)
      _FunctionsDB.MontaSQL(strSql, fili_descricao, Imperia.Common.Functions_DB.tipo_Campo.Texto, True)
      _FunctionsDB.MontaSQL(strSql, fili_in_bloqueado, Imperia.Common.Functions_DB.tipo_Campo.Boleano, False)
  ...
  Public Function Insert(ByVal fili_descricao As String, ByVal fili_in_bloqueado As String) As Integer

    Try

      Dim strSql As String = "ca_sp_filial_INSERT "
      _FunctionsDB.MontaSQL(strSql, fili_descricao, Imperia.Common.Functions_DB.tipo_Campo.Texto, True)
      _FunctionsDB.MontaSQL(strSql, fili_in_bloqueado, Imperia.Common.Functions_DB.tipo_Campo.Boleano, False)
